...
_OPCODE(NULL,                             0,          OP_EVAL_OPC,                0,  0,  0)
...
_OPCODE("map",                            IPROC,      OP_MAP,                     0,  0,  0)
_OPCODE("for-each",                       IPROC,      OP_FOREACH,                 0,  0,  0)
_OPCODE("eval",                           IPROC,      OP_PEVAL,                   0,  0,  0)
...
_OPCODE("load",                           IPROC,      OP_LOAD,                    0,  0,  0)
...
_OPCODE("odd?",                           IPROC,      OP_ODD_P,                   0,  0,  0)
_OPCODE("even?",                          IPROC,      OP_EVEN_P,                  0,  0,  0)
_OPCODE("<",                              IPROC,      OP_LP,                      0,  0,  0)
_OPCODE("<=",                             IPROC,      OP_LEP,                     0,  0,  0)
_OPCODE(">",                              IPROC,      OP_GP,                      0,  0,  0)
_OPCODE(">=",                             IPROC,      OP_GEP,                     0,  0,  0)
_OPCODE("=",                              IPROC,      OP_EP,                      0,  0,  0)
_OPCODE("+",                              IPROC,      OP_ADD,                     0,  0xFFFF, T_NUMBER)
_OPCODE("-",                              IPROC,      OP_SUB,                     0,  0xFFFF, T_NUMBER)
