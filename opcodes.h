...
_OPCODE(op_func0, "set!",                           SYNTAX,     OP_SET,                     2,  2,  0)
...
_OPCODE(op_func0, "begin",                          SYNTAX,     OP_BEGIN,                   0,  0xFFFF,  0)
...
_OPCODE(op_func1, "newline",                        IPROC,      OP_NEWLINE,                 0,  1,  T_OUTPORT)
...
_OPCODE(op_func2, "not",                            IPROC,      OP_NOT,                     1,  1,  0)
_OPCODE(op_func2, "null?",                          IPROC,      OP_NULL_P,                  1,  1,  0)
_OPCODE(op_func2, "boolean?",                       IPROC,      OP_BOOLEAN_P,               1,  1,  0)
...
_OPCODE(op_func2, "string?",                        IPROC,      OP_STRING_P,                1,  1,  0)
...
_OPCODE(op_func2, "vector?",                        IPROC,      OP_VECTOR_P,                1,  1,  0)
_OPCODE(op_func2, "vector",                         IPROC,      OP_VECTOR,                  0,  0xFFFF,  0)
_OPCODE(op_func2, "make-vector",                    IPROC,      OP_MAKE_VECTOR,             1,  2,  T_NATURAL T_ANY)
_OPCODE(op_func2, "vector-length",                  IPROC,      OP_VECTOR_LENGTH,           1,  1,  T_VECTOR)
_OPCODE(op_func2, "vector-ref",                     IPROC,      OP_VECTOR_REF,              2,  2,  T_VECTOR T_NATURAL)
_OPCODE(op_func2, "vector-set!",                    IPROC,      OP_VECTOR_SET,              3,  3,  T_VECTOR T_NATURAL T_ANY)
_OPCODE(op_func2, "vector-fill!",                   IPROC,      OP_VECTOR_FILL,             2,  0xFFFF,  0)
_OPCODE(op_func2, "vector->list",                   IPROC,      OP_VECTOR_TO_LIST,          1,  1,  T_VECTOR)
_OPCODE(op_func2, "list?",                          IPROC,      OP_LIST_P,                  1,  1,  0)
_OPCODE(op_func2, "list",                           IPROC,      OP_LIST,                    0,  0xFFFF,  0)
_OPCODE(op_func2, "list->string",                   IPROC,      OP_LIST_TO_STRING,          1,  1,  T_LIST)
_OPCODE(op_func2, "list->vector",                   IPROC,      OP_LIST_TO_VECTOR,          1,  1,  T_LIST)
...
_OPCODE(op_func2, "cons",                           IPROC,      OP_CONS,                    2,  2,  0)
_OPCODE(op_func2, "car",                            IPROC,      OP_CAR,                     1,  1,  T_PAIR)
_OPCODE(op_func2, "cdr",                            IPROC,      OP_CDR,                     1,  1,  T_PAIR)
_OPCODE(op_func2, "set-car!",                       IPROC,      OP_SET_CAR,                 2,  2,  T_PAIR T_ANY)
_OPCODE(op_func2, "set-cdr!",                       IPROC,      OP_SET_CDR,                 2,  2,  T_PAIR T_ANY)
_OPCODE(op_func2, "length",                         IPROC,      OP_LENGTH,                  1,  1,  T_LIST)
_OPCODE(op_func2, "append",                         IPROC,      OP_APPEND,                  0,  0xFFFF, 0)
_OPCODE(op_func2, "reverse",                        IPROC,      OP_REVERSE,                 1,  1,  T_LIST)
_OPCODE(op_func2, "list-tail",                      IPROC,      OP_LIST_TAIL,               2,  2,  T_LIST T_NATURAL)
_OPCODE(op_func2, "list-ref",                       IPROC,      OP_LIST_REF,                2,  2,  T_LIST T_NATURAL)
_OPCODE(op_func2, "memq",                           IPROC,      OP_MEMQ,                    2,  2,  T_ANY T_LIST)
_OPCODE(op_func2, "memv",                           IPROC,      OP_MEMV,                    2,  2,  T_ANY T_LIST)
_OPCODE(op_func2, "member",                         IPROC,      OP_MEMBER,                  2,  2,  T_ANY T_LIST)
_OPCODE(op_func2, "assq",                           IPROC,      OP_ASSQ,                    2,  2,  T_ANY T_LIST)
_OPCODE(op_func2, "assv",                           IPROC,      OP_ASSV,                    2,  2,  T_ANY T_LIST)
_OPCODE(op_func2, "assoc",                          IPROC,      OP_ASSOC,                   2,  2,  T_ANY T_LIST)

_OPCODE(op_func3, "number?",                        IPROC,      OP_NUMBER_P,                1,  1,  0)
