...
_OPCODE(op_func0, "let",                            SYNTAX,     OP_LET,                     2,  0xFFFF,  0)
_OPCODE(op_func0, "let*",                           SYNTAX,     OP_LETSEQ,                  0,  0,  0)
...
_OPCODE(op_func0, "define-syntax",                  SYNTAX,     OP_DEFINE_SYNTAX,           0,  0,  0)
_OPCODE(op_func0, "let-syntax",                     SYNTAX,     OP_LET_SYNTAX,              0,  0,  0)
_OPCODE(op_func0, "letrec-syntax",                  SYNTAX,     OP_LETREC_SYNTAX,           0,  0,  0)
_OPCODE(op_func0, "syntax-rules",                   SYNTAX,     OP_SYNTAX_RULES,            0,  0,  0)
...
_OPCODE(op_func0, "call-with-current-continuation", IPROC,      OP_CALLCC,                   0,  0,  0)
_OPCODE(op_func0, "call/cc",                        IPROC,      OP_CALLCC_ALIAS,                   0,  0,  0)
...
_OPCODE(op_func3, "-",                              IPROC,      OP_SUB,                   0,  0,  0)
_OPCODE(op_func3, "*",                              IPROC,      OP_MULTI,                   0,  0,  0)
_OPCODE(op_func3, "/",                              IPROC,      OP_DIV,                   0,  0,  0)
