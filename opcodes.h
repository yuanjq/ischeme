...
_OPCODE("read",                           IPROC,      OP_READ,                    0,  1,  T_INPORT)
_OPCODE("write",                          IPROC,      OP_WRITE,                   1,  2,  T_ANY T_OUTPORT)
_OPCODE("read-char",                      IPROC,      OP_READ_CHAR,               0,  1,  T_INPORT)
_OPCODE("write-char",                     IPROC,      OP_WRITE_CHAR,              1,  2,  T_CHAR T_OUTPORT)
_OPCODE("peek-char",                      IPROC,      OP_PEEK_CHAR,               0,  1,  T_INPORT)
_OPCODE("char-ready?",                    IPROC,      OP_CHAR_READY_P,            0,  1,  T_INPORT)
_OPCODE("eof-object?",                    IPROC,      OP_EOF_OBJECT_P,            1,  1,  0)
_OPCODE("open-input-file",                IPROC,      OP_OPEN_INPUT_FILE,         1,  1,  T_STRING)
_OPCODE("open-output-file",               IPROC,      OP_OPEN_OUTPUT_FILE,        1,  1,  T_STRING)
_OPCODE("close-input-port",               IPROC,      OP_CLOSE_INPUT_PORT,        1,  1,  T_INPORT)
_OPCODE("close-output-port",              IPROC,      OP_CLOSE_OUTPUT_PORT,       1,  1,  T_OUTPORT)
_OPCODE("port?",                          IPROC,      OP_PORT_P,                  1,  1,  0)
_OPCODE("input-port?",                    IPROC,      OP_INPUT_PORT_P,            1,  1,  0)
_OPCODE("output-port?",                   IPROC,      OP_OUTPUT_PORT_P,           1,  1,  0)
_OPCODE("current-input-port",             IPROC,      OP_CURR_INPUT_PORT,         0,  0,  0)
_OPCODE("current-output-port",            IPROC,      OP_CURR_OUTPUT_PORT,        0,  0,  0)
_OPCODE("set-current-input-port!",        IPROC,      OP_SET_CURR_INPUT_PORT,     1,  1,  T_INPORT)
_OPCODE("set-current-output-port!",       IPROC,      OP_SET_CURR_OUTPUT_PORT,    1,  1,  T_OUTPORT)
_OPCODE("call-with-input-file",           IPROC,      OP_CALL_WITH_INPUT_FILE,    2,  2,  T_STRING T_PROC)
_OPCODE(NULL,                             0,          OP_CALL_WITH_INPUT_FILE1,   0,  0, 0)
_OPCODE(NULL,                             0,          OP_CALL_WITH_INPUT_FILE2,   0,  0, 0)
_OPCODE("call-with-output-file",          IPROC,      OP_CALL_WITH_OUTPUT_FILE,   2,  2,  T_STRING T_PROC)
_OPCODE(NULL,                             0,          OP_CALL_WITH_OUTPUT_FILE1,  0,  0, 0)
_OPCODE(NULL,                             0,          OP_CALL_WITH_OUTPUT_FILE2,  0,  0, 0)
...
_OPCODE("char=?",                         IPROC,      OP_CHAR_EP,                 2,  2,  T_CHAR T_CHAR)
_OPCODE("char<?",                         IPROC,      OP_CHAR_LP,                 2,  2,  T_CHAR T_CHAR)
_OPCODE("char<=?",                        IPROC,      OP_CHAR_LEP,                2,  2,  T_CHAR T_CHAR)
_OPCODE("char>?",                         IPROC,      OP_CHAR_GP,                 2,  2,  T_CHAR T_CHAR)
_OPCODE("char>=?",                        IPROC,      OP_CHAR_GEP,                2,  2,  T_CHAR T_CHAR)
_OPCODE("char-ci=?",                      IPROC,      OP_CHAR_CI_EP,              2,  2,  T_CHAR T_CHAR)
_OPCODE("char-ci<?",                      IPROC,      OP_CHAR_CI_LP,              2,  2,  T_CHAR T_CHAR)
_OPCODE("char-ci<=?",                     IPROC,      OP_CHAR_CI_LEP,             2,  2,  T_CHAR T_CHAR)
_OPCODE("char-ci>?",                      IPROC,      OP_CHAR_CI_GP,              2,  2,  T_CHAR T_CHAR)
_OPCODE("char-ci>=?",                     IPROC,      OP_CHAR_CI_GEP,             2,  2,  T_CHAR T_CHAR)
_OPCODE("char-alphabetic?",               IPROC,      OP_CHAR_ALPHA_P,            1,  1,  T_CHAR)
_OPCODE("char-numeric?",                  IPROC,      OP_CHAR_NUMBER_P,           1,  1,  T_CHAR)
_OPCODE("char-whitespace?",               IPROC,      OP_CHAR_SPACE_P,            1,  1,  T_CHAR)
_OPCODE("char-upper-case?",               IPROC,      OP_CHAR_UPPER_P,            1,  1,  T_LETTER)
_OPCODE("char-lower-case?",               IPROC,      OP_CHAR_LOWER_P,            1,  1,  T_LETTER)

_OPCODE("string?",                        IPROC,      OP_STRING_P,                1,  1,  0)
_OPCODE("string=?",                       IPROC,      OP_STRING_EP,               2,  2,  T_STRING T_STRING)
_OPCODE("string<?",                       IPROC,      OP_STRING_LP,               2,  2,  T_STRING T_STRING)
_OPCODE("string<=?",                      IPROC,      OP_STRING_LEP,              2,  2,  T_STRING T_STRING)
_OPCODE("string>?",                       IPROC,      OP_STRING_GP,               2,  2,  T_STRING T_STRING)
_OPCODE("string>=?",                      IPROC,      OP_STRING_GEP,              2,  2,  T_STRING T_STRING)
_OPCODE("string-ci=?",                    IPROC,      OP_STRING_CI_EP,            2,  2,  T_STRING T_STRING)
_OPCODE("string-ci<?",                    IPROC,      OP_STRING_CI_LP,            2,  2,  T_STRING T_STRING)
_OPCODE("string-ci<=?",                   IPROC,      OP_STRING_CI_LEP,           2,  2,  T_STRING T_STRING)
_OPCODE("string-ci>?",                    IPROC,      OP_STRING_CI_GP,            2,  2,  T_STRING T_STRING)
_OPCODE("string-ci>=?",                   IPROC,      OP_STRING_CI_GEP,           2,  2,  T_STRING T_STRING)
...
_OPCODE("symbol->string",                 IPROC,      OP_SYMBOL_TO_STRING,        1,  1,  T_SYMBOL)
_OPCODE("string",                         IPROC,      OP_STRING,                  0,  0xFFFF, T_CHAR)
_OPCODE("make-string",                    IPROC,      OP_MAKE_STRING,             1,  2,  T_NATURAL T_CHAR)
_OPCODE("string-length",                  IPROC,      OP_STRING_LENGTH,           1,  1,  T_STRING)
_OPCODE("string-ref",                     IPROC,      OP_STRING_REF,              2,  2,  T_STRING T_NATURAL)
_OPCODE("string-set!",                    IPROC,      OP_STRING_SET,              3,  3,  T_STRING T_NATURAL T_CHAR)
_OPCODE("substring",                      IPROC,      OP_SUBSTRING,               3,  3,  T_STRING T_NATURAL T_NATURAL)
_OPCODE("string-append",                  IPROC,      OP_STRING_APPEND,           0,  0xFFFF, T_STRING)
_OPCODE("string-copy",                    IPROC,      OP_STRING_COPY,             1,  1,  T_STRING)
_OPCODE("string-fill!",                   IPROC,      OP_STRING_FILL,             2,  2,  T_STRING T_CHAR)
_OPCODE("string->symbol",                 IPROC,      OP_STRING_TO_SYMBOL,        1,  1,  T_STRING)
_OPCODE("string->list",                   IPROC,      OP_STRING_TO_LIST,          1,  1,  T_STRING)
_OPCODE("string->number",                 IPROC,      OP_STRING_TO_NUMBER,        1,  1,  T_STRING)
_OPCODE("char->integer",                  IPROC,      OP_CHAR_TO_INTEGER,         1,  1,  T_CHAR)
_OPCODE("char-upcase",                    IPROC,      OP_CHAR_UPCASE,             1,  1,  T_CHAR)
_OPCODE("char-downcase",                  IPROC,      OP_CHAR_DOWNCASE,           1,  1,  T_CHAR)
...
_OPCODE("integer?",                       IPROC,      OP_INTEGER_P,               1,  1,  0)
_OPCODE("rational?",                      IPROC,      OP_RATIONAL_P,              1,  1,  0)
_OPCODE("real?",                          IPROC,      OP_REAL_P,                  1,  1,  0)
_OPCODE("complex?",                       IPROC,      OP_COMPLEX_P,               1,  1,  0)
_OPCODE("exact?",                         IPROC,      OP_EXACT_P,                 1,  1,  T_NUMBER)
_OPCODE("inexact?",                       IPROC,      OP_INEXACT_P,               1,  1,  T_NUMBER)
_OPCODE("zero?",                          IPROC,      OP_ZERO_P,                  1,  1,  T_NUMBER)
_OPCODE("negative?",                      IPROC,      OP_NEGATIVE_P,              1,  1,  T_REAL)
_OPCODE("positive?",                      IPROC,      OP_POSITIVE_P,              1,  1,  T_REAL)
...
_OPCODE("abs",                            IPROC,      OP_ABS,                     1,  1,  T_REAL)
_OPCODE("quotient",                       IPROC,      OP_QUOTIENT,                2,  2,  T_INTEGER)
_OPCODE("remainder",                      IPROC,      OP_REMAINDER,               2,  2,  T_INTEGER)
_OPCODE("modulo",                         IPROC,      OP_MODULO,                  2,  2,  T_INTEGER)
_OPCODE("gcd",                            IPROC,      OP_GCD,                     0,  0xFFFF,  T_INTEGER)
_OPCODE("lcm",                            IPROC,      OP_LCM,                     0,  0xFFFF,  T_INTEGER)
...
_OPCODE("inexact->exact",                 IPROC,      OP_INEXACT_TO_EXACT,        1,  1,  T_NUMBER)
_OPCODE("exact->inexact",                 IPROC,      OP_EXACT_TO_INEXACT,        1,  1,  T_NUMBER)
_OPCODE("max",                            IPROC,      OP_MAX,                     1,  0xFFFF,  T_REAL)
_OPCODE("min",                            IPROC,      OP_MIN,                     1,  0xFFFF,  T_REAL)
...
_OPCODE("real-part",                      IPROC,      OP_REAL_PART,               1,  1,  T_NUMBER)
_OPCODE("imag-part",                      IPROC,      OP_IMAG_PART,               1,  1,  T_NUMBER)
_OPCODE("magnitude",                      IPROC,      OP_MAGNITUDE,               0,  0,  0)
_OPCODE("angle",                          IPROC,      OP_ANGLE,                   0,  0,  0)
_OPCODE("number->string",                 IPROC,      OP_NUMBER_TO_STRING,        1,  1,  T_NUMBER)
_OPCODE("integer->char",                  IPROC,      OP_INTEGER_TO_CHAR,         1,  1,  T_INTEGER)
